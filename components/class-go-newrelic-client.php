...
class GO_NewRelic_Client
{
	...
	public function __construct()
	{
		...
		if ( $this->settings )
		{
			add_action( 'wp_head', array( $this, 'output_browser_tracking_code' ) );
	...
	{
		wp_get_option
		// includes JS, can't be sanitized, review the static string in the config file
		?>
